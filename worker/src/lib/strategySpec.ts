...
const ALPHABUILDERS_MULTIFACTOR_STRATEGY_SPECS: StrategySpec[] = [
  {
    id: 'alphabuilders_multifactor_trend_reclaim_v1',
    version: STRATEGY_SPEC_VERSION,
    name: 'AlphaBuilders multifactor trend reclaim',
    status: 'active',
    owner: 'strategy',
    familyId: 'TREND_RECLAIM_CONTINUATION',
    variantId: 'ma_macd_adx_rsi_volume_reclaim_v1',
    ownerType: 'strategy',
    promotionStatus: 'production',
    alphaBucket: 'trend_following',
    supportedRegimes: ['bull', 'sideways', 'volatile'],
    thesis: 'Use price reclaim, volume confirmation, and trend-strength evidence as an AlphaBuilders broad-market trend label before PLE routing.',
    thresholds: {
      minPrice: 10,
      minCloseAboveMa20Pct: -0.02,
      minCloseAboveMa60Pct: -0.05,
      ...
      dsl: {
        any: [
          ...
          { signal: 'technicalIndicators.rsi14', op: '>=', value: 45 },
        ],
        not: [
          { signal: 'technicalIndicators.rsi14', op: '>=', value: 82 },
        ],
      },
    },
    candidatePolicy: {
      poolQuota: 18,
      costBudget: 20,
      evidenceRequirements: ['raw_price_structure', 'raw_volume', 'raw_trend_strength'],
      maxMlShare: 0.28,
    },
    riskNotes: ['Trend reclaim is a label only; L1.25 and PLE own weighting and slate selection.'],
    createdBy: 'p5_strategy_governance',
  },
  {
    id: 'alphabuilders_multifactor_breakout_compression_v1',
    version: STRATEGY_SPEC_VERSION,
    name: 'AlphaBuilders multifactor breakout compression',
    status: 'active',
    owner: 'strategy',
    familyId: 'VOLATILITY_CONTRACTION_BREAKOUT',
    variantId: 'bb_squeeze_volume_breakout_v1',
    ownerType: 'strategy',
    promotionStatus: 'production',
    alphaBucket: 'breakout_vol_expansion',
    supportedRegimes: ['bull', 'sideways', 'volatile'],
    thesis: 'Use volatility compression, base breakout, and volume expansion evidence as an AlphaBuilders breakout label.',
    thresholds: {
      minPrice: 10,
      minCloseAboveMa20Pct: 0,
      minCloseAboveMa60Pct: -0.03,
      minVolumeExpansion20: 1.05,
      minReturn20d: -0.02,
      dsl: {
        any: [
          { signal: 'technicalIndicators.squeezeRelease', op: '>=', value: 1 },
          { signal: 'technicalIndicators.squeezeMomentum', op: '>=', value: 0 },
          { signal: 'technicalIndicators.bbPctB', op: '>=', value: 0.72 },
    ...
    candidatePolicy: {
      poolQuota: 18,
      costBudget: 20,
      evidenceRequirements: ['raw_price_structure', 'raw_volume', 'raw_breakout', 'raw_volatility_compression'],
      maxMlShare: 0.28,
    },
    riskNotes: ['Breakout false positives remain expected; L2/L3 and sparse allocation own rejection.'],
    createdBy: 'p5_strategy_governance',
  },
  {
    id: 'alphabuilders_multifactor_smart_money_accumulation_v1',
    version: STRATEGY_SPEC_VERSION,
    name: 'AlphaBuilders multifactor smart money accumulation',
    status: 'active',
    owner: 'strategy',
    familyId: 'SMART_MONEY_ACCUMULATION',
    variantId: 'institutional_chip_reclaim_v1',
    ownerType: 'strategy',
    promotionStatus: 'production',
    alphaBucket: 'defensive_accumulation',
    supportedRegimes: ['bull', 'sideways', 'bear', 'volatile'],
    thesis: 'Use institutional flow plus tolerable price structure as an AlphaBuilders accumulation label.',
    thresholds: {
      minPrice: 10,
      minCloseAboveMa20Pct: -0.08,
      minVolumeExpansion20: 0.65,
      dsl: {
        any: [
          { signal: 'foreignTrustNet5d', op: '>=', value: 0 },
          { signal: 'dealerNet5d', op: '>=', value: 0 },
          { signal: 'factorSignals.sectorFlowCore', op: '>=', value: 1 },
        ],
      },
    },
    candidatePolicy: {
      poolQuota: 18,
      costBudget: 20,
      evidenceRequirements: ['raw_chip_flow', 'raw_price_structure', 'sector_flow'],
      maxMlShare: 0.28,
    },
    riskNotes: ['Accumulation can be stale; L1.25 reliability and L4 sparse risk own final exposure.'],
    createdBy: 'p5_strategy_governance',
  },
  {
    ...
    alphaBucket: 'trend_following',
    supportedRegimes: ['bull', 'sideways', 'volatile'],
    thesis: 'Use monthly revenue acceleration with price or volume confirmation as an AlphaBuilders fundamental momentum label.',
    thresholds: {
      minPrice: 10,
    ...
    candidatePolicy: {
      poolQuota: 18,
      costBudget: 20,
      evidenceRequirements: ['raw_revenue_revision', 'raw_price_structure', 'raw_volume'],
      maxMlShare: 0.28,
    },
    riskNotes: ['Fundamental hard gates avoid sparse ROE/EPS/PE fields until those feeds are complete.'],
    createdBy: 'p5_strategy_governance',
  },
  {
    id: 'alphabuilders_multifactor_sector_rotation_core_v1',
    version: STRATEGY_SPEC_VERSION,
    name: 'AlphaBuilders multifactor sector rotation core',
    status: 'active',
    owner: 'strategy',
    familyId: 'SECTOR_ROTATION_CORE',
    variantId: 'sector_flow_rrg_relative_strength_v1',
    ownerType: 'strategy',
    promotionStatus: 'production',
    alphaBucket: 'trend_following',
    supportedRegimes: ['bull', 'sideways', 'volatile'],
    thesis: 'Use sector-flow core membership and relative-strength rotation as an AlphaBuilders theme leadership label.',
    thresholds: {
      minPrice: 10,
      minVolumeExpansion20: 0.65,
      minFactorSignals: {
      ...
      dsl: {
        any: [
          { signal: 'factorSignals.sectorRsRatio', op: '>=', value: 98 },
    ...
    candidatePolicy: {
      poolQuota: 18,
      costBudget: 20,
      evidenceRequirements: ['sector_flow', 'relative_strength_rotation', 'theme_leadership'],
      maxMlShare: 0.28,
    },
    riskNotes: ['Sector leadership is evidence only; cluster exposure prevents crowded theme allocation.'],
    createdBy: 'p5_strategy_governance',
  },
  {
    id: 'alphabuilders_multifactor_smc_reclaim_v1',
    version: STRATEGY_SPEC_VERSION,
    name: 'AlphaBuilders multifactor SMC reclaim',
    status: 'active',
    owner: 'strategy',
    familyId: 'SMC_STRUCTURE_RECLAIM',
    variantId: 'liquidity_sweep_bos_choch_displacement_v1',
    ownerType: 'strategy',
    promotionStatus: 'production',
    alphaBucket: 'mean_reversion',
    supportedRegimes: ['bull', 'sideways', 'volatile'],
    thesis: 'Use SMC price-action reclaim signals as an AlphaBuilders structure-repair label.',
    thresholds: {
      minPrice: 10,
      minVolumeExpansion20: 0.65,
      maxReturn20d: 0.2,
    ...
    candidatePolicy: {
      poolQuota: 18,
      costBudget: 20,
      evidenceRequirements: ['raw_price_action_structure', 'liquidity_sweep', 'bos_choch', 'displacement'],
      maxMlShare: 0.28,
    },
    riskNotes: ['SMC label does not trigger buys; it gives PLE a separate structure-reclaim view.'],
    createdBy: 'p5_strategy_governance',
  },
]

const RESEARCH_CONSOLIDATED_STRATEGY_SPECS: StrategySpec[] = [
  {
    id: 'research_consolidated_technical_momentum_v1',
    version: STRATEGY_SPEC_VERSION,
    name: 'Research consolidated technical momentum',
    status: 'active',
    owner: 'strategy',
    familyId: 'TREND_RECLAIM_CONTINUATION',
    variantId: 'official_rsi_keltner_second_high_v1',
    ownerType: 'strategy',
    promotionStatus: 'production',
    alphaBucket: 'trend_following',
    supportedRegimes: ['bull', 'sideways', 'volatile'],
    thesis: 'Consolidates overlapping research RSI, Keltner, second-high, low-price momentum, and pure-technical trend screens into one production label.',
    thresholds: {
      minPrice: 10,
      minVolumeExpansion20: 0.75,
      minCloseAboveMa20Pct: -0.03,
      dsl: {
        any: [
          { signal: 'technicalIndicators.rsi14', op: '>=', value: 40 },
          { signal: 'technicalIndicators.macdHist', op: '>=', value: 0 },
          { signal: 'technicalIndicators.adx14', op: '>=', value: 15 },
          { signal: 'technicalIndicators.bbPctB', op: '>=', value: 0.65 },
        ],
      },
    },
    candidatePolicy: {
      poolQuota: 18,
      costBudget: 20,
      evidenceRequirements: ['research_consolidated', 'technical_momentum', 'rsi_keltner_breakout'],
      maxMlShare: 0.26,
    },
    riskNotes: ['Replaces multiple overlapping technical research variants; not a standalone selector.'],
    createdBy: 'p5_strategy_governance',
  },
  {
    id: 'research_consolidated_chip_margin_accumulation_v1',
    version: STRATEGY_SPEC_VERSION,
    name: 'Research consolidated chip margin accumulation',
    status: 'active',
    owner: 'strategy',
    familyId: 'SMART_MONEY_ACCUMULATION',
    variantId: 'foreign_margin_broker_flow_v1',
    ownerType: 'strategy',
    promotionStatus: 'production',
    alphaBucket: 'defensive_accumulation',
    supportedRegimes: ['bull', 'sideways', 'bear', 'volatile'],
    thesis: 'Consolidates foreign ownership, institutional trading, margin balance, and credit-recovery research factors into one chip-flow label.',
    thresholds: {
      minPrice: 10,
      minVolumeExpansion20: 0.6,
      minCloseAboveMa20Pct: -0.1,
      dsl: {
        any: [
          { signal: 'foreignTrustNet5d', op: '>=', value: 0 },
          { signal: 'dealerNet5d', op: '>=', value: 0 },
          { signal: 'brokerNetAmount5d', op: '>=', value: 0 },
          { signal: 'factorSignals.sectorFlowCore', op: '>=', value: 1 },
        ],
      },
    },
    candidatePolicy: {
      poolQuota: 18,
      costBudget: 20,
      evidenceRequirements: ['research_consolidated', 'chip_flow', 'margin_flow', 'institutional_flow'],
      maxMlShare: 0.26,
    },
    riskNotes: ['Keeps chip and margin evidence broad; L1.25 down-weights crowded or stale flow.'],
    createdBy: 'p5_strategy_governance',
  },
  {
    id: 'research_consolidated_revenue_acceleration_v1',
    version: STRATEGY_SPEC_VERSION,
    name: 'Research consolidated revenue acceleration',
    status: 'active',
    owner: 'strategy',
    familyId: 'REVENUE_QUALITY_MOMENTUM',
    variantId: 'monthly_revenue_revision_v1',
    ownerType: 'strategy',
    promotionStatus: 'production',
    alphaBucket: 'trend_following',
    supportedRegimes: ['bull', 'sideways', 'volatile'],
    thesis: 'Consolidates monthly revenue, revenue-price dual momentum, ROTC revenue, and revenue revision research factors into one revenue acceleration label.',
    thresholds: {
      minPrice: 10,
      minVolumeExpansion20: 0.65,
      minFactorSignals: {
      ...
      dsl: {
        any: [
          { signal: 'factorSignals.monthlyRevenueMoM', op: '>=', value: 0 },
          { signal: 'technicalIndicators.macdHist', op: '>=', value: 0 },
          { signal: 'closeAboveMa20Pct', op: '>=', value: -0.03 },
        ],
      },
    },
    candidatePolicy: {
      poolQuota: 18,
      costBudget: 20,
      evidenceRequirements: ['research_consolidated', 'monthly_revenue', 'revenue_revision'],
      maxMlShare: 0.26,
    },
    riskNotes: ['Avoids hard dependence on sparse quarterly fundamentals; monthly revenue is the durable evidence source.'],
    createdBy: 'p5_strategy_governance',
  },
  {
    id: 'research_consolidated_quality_value_v1',
    version: STRATEGY_SPEC_VERSION,
    name: 'Research consolidated quality value',
    status: 'active',
    owner: 'strategy',
    familyId: 'REVENUE_QUALITY_MOMENTUM',
    variantId: 'peg_pb_cashflow_quality_v1',
    ownerType: 'strategy',
    promotionStatus: 'production',
    alphaBucket: 'mean_reversion',
    supportedRegimes: ['sideways', 'bear', 'volatile'],
    thesis: 'Consolidates PEG, PB, high-dividend, financial-score, cash-flow value, and multi-industry value research variants into one quality-value label.',
    thresholds: {
      minPrice: 10,
      maxReturn20d: 0.16,
      ...
      dsl: {
        any: [
          ...
          { signal: 'eps', op: '>=', value: 0 },
          { signal: 'roe', op: '>=', value: 3 },
          { signal: 'pb', op: '<=', value: 3.5 },
          { signal: 'pe', op: '<=', value: 60 },
        ],
      },
    },
    candidatePolicy: {
      poolQuota: 18,
      costBudget: 20,
      evidenceRequirements: ['research_consolidated', 'quality_value', 'valuation'],
      maxMlShare: 0.26,
    },
    riskNotes: ['Sparse fundamental fields are optional evidence through DSL any, not hard blockers.'],
    createdBy: 'p5_strategy_governance',
  },
  {
    id: 'research_consolidated_theme_macro_rotation_v1',
    version: STRATEGY_SPEC_VERSION,
    name: 'Research consolidated theme macro rotation',
    status: 'active',
    owner: 'strategy',
    familyId: 'SECTOR_ROTATION_CORE',
    variantId: 'industry_theme_macro_filter_v1',
    ownerType: 'strategy',
    promotionStatus: 'production',
    alphaBucket: 'trend_following',
    supportedRegimes: ['bull', 'sideways', 'volatile'],
    thesis: 'Consolidates industry-theme, Taiwan macro ETF, market filter, semiconductor and PC-theme research screens into one theme-rotation label.',
    thresholds: {
      minPrice: 10,
      minVolumeExpansion20: 0.6,
      dsl: {
    ...
    candidatePolicy: {
      poolQuota: 18,
      costBudget: 20,
      evidenceRequirements: ['research_consolidated', 'industry_theme', 'macro_rotation', 'sector_flow'],
      maxMlShare: 0.26,
    },
    riskNotes: ['Theme rotation evidence must be de-crowded by similarity graph and L4 cluster exposure.'],
    createdBy: 'p5_strategy_governance',
  },
  {
    id: 'research_consolidated_defensive_low_volatility_v1',
    version: STRATEGY_SPEC_VERSION,
    name: 'Research consolidated defensive low volatility',
    status: 'active',
    owner: 'strategy',
    familyId: 'SMART_MONEY_ACCUMULATION',
    variantId: 'low_volatility_defensive_recovery_v1',
    ownerType: 'strategy',
    promotionStatus: 'production',
    alphaBucket: 'defensive_accumulation',
    supportedRegimes: ['sideways', 'bear', 'volatile'],
    thesis: 'Consolidates low-volatility value, defensive high-yield, credit-recovery, and cautious-market research screens into one defensive label.',
    thresholds: {
      minPrice: 10,
      maxReturn20d: 0.14,
      minVolumeExpansion20: 0.5,
      dsl: {
        any: [
          { signal: 'foreignTrustNet5d', op: '>=', value: 0 },
          { signal: 'technicalIndicators.atr14', op: '<=', value: 8 },
          { signal: 'technicalIndicators.rsi14', op: '<=', value: 68 },
          { signal: 'factorSignals.monthlyRevenueYoY', op: '>=', value: 0 },
        ],
      },
    },
    candidatePolicy: {
      poolQuota: 18,
      costBudget: 20,
      evidenceRequirements: ['research_consolidated', 'defensive', 'low_volatility', 'recovery'],
      maxMlShare: 0.26,
    },
    riskNotes: ['Defensive labels should improve breadth in weak regimes without bypassing ML and sparse allocation.'],
    createdBy: 'p5_strategy_governance',
  },
]

const LEGACY_STRATEGY_SPEC_DRAFTS: StrategySpec[] = [
  {
...
const DEFAULT_STRATEGY_SPEC_DRAFTS: StrategySpec[] = [
  ...LEGACY_STRATEGY_SPEC_DRAFTS.map((spec) => spec.id === 'finlab_ai_skill_discovery_v1'
    ? {
        ...spec,
        status: 'retired' as const,
        ownerType: 'retired' as const,
        promotionStatus: 'retired' as const,
      }
    : spec),
  ...RESEARCH_CONSOLIDATED_STRATEGY_SPECS,
  ...ALPHABUILDERS_MULTIFACTOR_STRATEGY_SPECS,
]
