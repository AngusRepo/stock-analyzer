...
const TWSE_INDUSTRY_MAP: Record<string, string> = {
  ...
  '05': '電機機械', '06': '電器電纜', '08': '生技醫療', '09': '玻璃陶瓷',
  '10': '造紙工業', '11': '鋼鐵工業', '12': '橡膠工業', '14': '半導體業',
  '15': '電腦及週邊設備業', '16': '光電業', '17': '通信網路業',
  '18': '電子零組件業', '20': '資訊服務業', '21': '其他電子業',
  '22': '建材營造業', '23': '航運業', '24': '觀光餐旅', '25': '金融保險業',
  '26': '貿易百貨業', '27': '油電燃氣業', '28': '綜合', '29': '其他',
  '31': '居家生活', '35': '汽車工業', '36': '數位雲端',
}

// OTC (TPEX) 官方產業
const TPEX_INDUSTRY_MAP: Record<string, string> = {
  '01': '食品工業', '02': '塑膠工業', '03': '紡織纖維', '04': '電機機械',
  '05': '電器電纜', '06': '化學工業', '08': '玻璃陶瓷', '10': '鋼鐵工業',
  '11': '橡膠工業', '12': '建材營造', '14': '半導體業', '15': '電腦及週邊設備業',
  '16': '光電業', '17': '通信網路業', '18': '電子零組件業', '20': '資訊服務業',
  '21': '其他電子業', '22': '生技醫療', '23': '油電燃氣業', '24': '觀光餐旅',
  '25': '貿易百貨', '26': '居家生活', '27': '其他', '28': '文化創意業',
  '29': '農業科技', '30': '電子商務', '31': '航運業', '32': '綠能環保',
  '33': '數位雲端',
}
