...
assert(workbench.includes('Promotion readiness'), 'Model Pool cockpit should keep selected-model readiness as one focused drilldown panel')
...
assert(workbench.includes('Promotion readiness funnel'), 'Selected-model drilldown should show a per-model readiness funnel')
...
assert(workbench.includes('dataset, pointer, promotion pressure, PBO/CPCV, and missing evidence'), 'Model Pool cockpit should show dataset, pointer, promotion pressure, PBO/CPCV, and missing evidence in the evidence table')
