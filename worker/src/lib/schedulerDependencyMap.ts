...
export const SCHEDULER_DEPENDENCY_MAP: Record<string, SchedulerDependencySpec> = {
  ...
  'allocator-ev-readiness': {
    ...
    currentFunction: 'Builds same-date allocator EV feature snapshots, refreshes L4 alpha EV, and attempts fusion refresh before recommendation allocation.',
    upstream: ['screener', 'regime-compute', 's12-structure-snapshot'],
    downstream: ['pipeline'],
    requiredBeforeDisable: [
      'pipeline must have same-date allocator_ev_feature_snapshots',
