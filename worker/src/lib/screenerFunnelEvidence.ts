...
function buildLayer15MultiStrategyRouterSummary(
  ...
  return {
    ...
    soft_capacity_baseline: toNullableNumber(evidence.soft_capacity_baseline),
    adaptive_target_size: toNullableNumber(evidence.adaptive_target_size),
    adaptive_capacity_max: toNullableNumber(evidence.adaptive_capacity_max),
    adaptive_capacity_reason: evidence.adaptive_capacity_reason ?? null,
    adaptive_capacity_eligible_count: toNullableNumber(evidence.adaptive_capacity_eligible_count),
    legacy_capacity_policy: 'max_only_no_minimum_no_topup',
    ...
    market_heat_score: normalizeScore01(components.market_heat_score ?? evidence.market_heat_score),
    market_heat_contribution: toNullableNumber(components.market_heat_contribution ?? evidence.market_heat_contribution),
    market_heat_alpha: toNullableNumber(components.market_heat_alpha),
