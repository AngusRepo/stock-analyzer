...
assert(continuation.includes("root?.status === 'error'"))
assert(continuation.includes('root.run_id === state.row.canonical_run_id'))
assert(continuation.includes('durableStageAdvanced'))
assert(continuation.includes('reconciled recovered post-screener continuation'))
