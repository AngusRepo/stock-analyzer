...
assert(modelPoolPage.includes('UpgradeTrackPanelV2'), 'ModelPool page should render artifact-gated L3 model tracks')
...
assert(modelPoolPage.includes('L2 coarse、L3 family ML'), 'ModelPool KPI copy should describe the new screener model flow')
