...
scheduleReadRoutes.get('/api/cron/schedule', (c) => {
  const schedule = [
    ...
    { task: 'ml-warmup', tw_time: '22:00 chain', description: 'Evening chain warmup，不是 production 決策 owner' },
    { task: 'market-data-update', tw_time: '22:00 chain', description: '更新價格、籌碼、技術指標與 snapshot manifest' },
    { task: 'screener', tw_time: '22:00 chain', description: '更新 screener seed 與上市櫃 / 興櫃分流' },
    ...
    { task: 'adapt', tw_time: 'post-verify chain', description: 'Adaptive params 與 GA / LinUCB evidence closure' },
    { task: 'daily-report', tw_time: 'post-adapt chain', description: '每日風險與交易摘要' },
    { task: 'weekly-audit', tw_time: 'weekly', description: 'Weekly audit report' },
    { task: 'obsidian-daily', tw_time: 'post-report chain', description: 'Obsidian daily notes + progress sync' },
