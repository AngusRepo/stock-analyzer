...
assert(strategyQueue.indexOf('await assertCanonicalStrategyDecisionGridParity(learningDb')
  < strategyQueue.indexOf('const coverage = await completeStrategyLearningRun'),
  'canonical matrix/log parity must be verified before completing materialization')
