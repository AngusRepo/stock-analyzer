...
assert(lifecycle.includes('postPipelineStage?.attempt_count'), 'snapshot retry budget must use the durable stage counter instead of the mixed lifecycle counter')
