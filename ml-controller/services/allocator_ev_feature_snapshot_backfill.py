...
def build_allocator_ev_feature_snapshots_for_date(
    *,
    ...
    # The post-pipeline native collector runs independently of formal allocation.
    ipo_shadow = {"status": "owned_by_post_pipeline_native_collector", "promotion_allowed": False}
