...
assert.match(queueBlock, /claimStrategyLearningPage\(learningDb/)
assert.match(queueBlock, /startStrategyLearningLeaseHeartbeat\(learningDb/)
...
assert.match(manualBlock, /claimStrategyLearningPage\(learningDb/)
assert.match(manualBlock, /startStrategyLearningLeaseHeartbeat\(learningDb/)
