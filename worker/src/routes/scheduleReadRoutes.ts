...
const schedule: ScheduleRow[] = [
  ...
  { task: 'source-readiness-probe', tw_time: '18:30-21:50 / 20m', owner: 'gcp_scheduler', parameter_mode: 'hard_boundary', layer: 'governance', description: 'Polls FinLab canonical and official supplemental readiness; starts full evening chain as soon as sources are current.' },
  { task: 'evening-chain', tw_time: '22:00 fallback', owner: 'gcp_scheduler', parameter_mode: 'hard_boundary', layer: 'governance', description: 'Fallback root; suppressed when readiness probe already completed the full chain.' },
