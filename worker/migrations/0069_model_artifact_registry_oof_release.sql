-- Expand the formal model artifact candidate contract for immutable OOF
-- full-fit releases. SQLite requires a table rebuild to change CHECK values.

PRAGMA foreign_keys=off;

CREATE TABLE model_artifact_registry_oof_release_new (
...
INSERT INTO model_artifact_registry_oof_release_new (
...
ALTER TABLE model_artifact_registry_oof_release_new RENAME TO model_artifact_registry;
