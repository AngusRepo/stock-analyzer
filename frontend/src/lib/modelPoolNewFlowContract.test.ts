...
assert(workbench.includes('State timeline'), 'Model Pool cockpit should show a Grafana-style state timeline')
assert(workbench.includes('Alert queue'), 'Model Pool cockpit should show blocker and promotion alerts')
assert(workbench.includes('Gate inspector'), 'Model Pool cockpit should keep promotion gate drilldown in an inspector')
...
assert(workbench.includes('dataset, pointer, and promotion pressure'), 'Model Pool cockpit should show dataset, pointer, and promotion pressure in the evidence table')
