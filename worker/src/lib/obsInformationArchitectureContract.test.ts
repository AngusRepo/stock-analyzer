...
assert(executionChain.includes("['allocator-ev-feature-snapshot-backfill']") && executionChain.includes("['active8-oof-daily']"), 'daily evidence lifecycle must be mapped')
