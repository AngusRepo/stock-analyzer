...

{
  ...
  assert(isTwIntradayTradingMinute(new Date('2026-05-02T02:00:00.000Z')) === false, 'Saturday must never be treated as an open market')
  assert(isTwIntradayTradingMinute(new Date('2026-04-29T02:00:00.000Z'), { holiday: true }) === false, 'exchange holiday must fail closed')
  assert(isTwIntradayTradingMinute(new Date('2026-04-29T05:32:00.000Z'), { delayedClose: true }) === true, 'delayed close may extend through 13:33')
}
