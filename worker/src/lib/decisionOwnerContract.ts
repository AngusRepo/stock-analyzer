...
export type AllocationUtilityOwner = 'expected_return_owner' | SelectionSignalOwner
...
export function resolveDecisionOwnerContract(
  ...
  return {
    ...
    allocation_utility_owner: expectedReturnOwner ? 'expected_return_owner' : 'score_v2_formal_ml',
