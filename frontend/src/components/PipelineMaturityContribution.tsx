...
const METRIC_LABELS: Record<string, string> = {
  ...
  absolute_spread_lcb90: '候選 Route 絕對報酬價差 LCB90', challenger_incumbent_delta_lcb90: '候選相對現行 Route 同容量增量 LCB90',
...
const BLOCKER_LABELS: Record<string, string> = {
  ...
  challenger_beats_incumbent_same_capacity_lcb90_positive: '候選 Route 尚未以同容量配對 LCB90 證明優於現行 Route',
