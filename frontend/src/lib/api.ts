...
export type SchedulerJob = {
  ...
  statusScope?: 'today' | 'historical_replay' | 'schedule' | 'cadence_cycle' | 'durable_event'
...
export type ModelUpgradeResearchStatusRow = {
  candidate_id: string
  stage: 'production_slot_member' | 'l2_feature_sidecar_member' | 'production_artifact_required' | 'shadow_challenger' | 'benchmark_only' | 'meta_optimizer' | 'state_space_overlay'
  family: string
  role: string
