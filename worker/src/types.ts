...
export type Bindings = {
  ...
  FINLAB_DAILY_SOURCE_KEY_SCOPE_JSON?: string
  FINLAB_DAILY_PRICE_KEY_SCOPE_JSON?: string
  FINLAB_DAILY_PRICE_KEEP_DIFF_COUNTS?: string
  OFFICIAL_SUPPLEMENTAL_FETCH_MODE?: string
...
export interface UpdateQueueMsg {
  ...
  schedulerRunId?: string // immutable run identity paired with schedulerTicketId for exact CAS settlement
