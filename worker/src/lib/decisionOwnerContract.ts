...
export function resolveDecisionOwnerContract(
  ...
  return {
    ...
    allocation_utility_owner: expectedReturnOwner ? 'expected_return_owner' : 'risk_abstention',
    execution_owner: 'allocator_opb_policy',
    execution_scope: 'recommendation_allocation_only_no_order_submission',
    action_gate: expectedReturnOwner ? 'expected_return_owner' : 'validated_expected_return_required',
  }
}
