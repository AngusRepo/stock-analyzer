...
export interface TradingConfig {
  ...
  // Research/observability threshold envelope only. Formal Active-8 signals
  // are owned by the immutable learned conformal artifact and never force top-K BUYs.
  // These values cannot control serving admission or allocation.
  ensemble_v2: {
...
export const DEFAULT_TRADING_CONFIG: TradingConfig = {
  ...
  // Research/observability threshold envelope; not a formal serving owner.
  ensemble_v2: {
