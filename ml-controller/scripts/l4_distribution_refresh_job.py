...
def execute(*,as_of,cadence,target_l3_artifact_id=None):
    ...
    run_key=digest({'source':manifest['manifest_checksum'],'identity':identity,'as_of':as_of,'cadence':cadence,'training_recipe':recipe})
...
if __name__=='__main__':
    print(json.dumps(execute(as_of=os.environ['L4_REFRESH_DATE'],cadence=os.environ['L4_REFRESH_CADENCE'],target_l3_artifact_id=os.environ.get('L4_PARENT_ARTIFACT_ID')),sort_keys=True))
