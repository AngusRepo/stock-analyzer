...
assert(standaloneJobs.includes("['weekly', 'pipeline_chain', 'daily', 'intraday', 'monthly']") && standaloneJobsCss.includes("[aria-label='Weekly operations'] { grid-column: span 4;") && standaloneJobsCss.includes("[aria-label='Pipeline support'] { grid-column: span 2;") && standaloneJobsCss.includes("[aria-label='Daily operations'] { grid-column: 1 / -1;") && standaloneJobsCss.includes("[aria-label='Daily operations'] .obs-standalone__job-grid") && standaloneJobsCss.includes('grid-template-columns: repeat(4, minmax(0, 1fr));'), 'standalone desktop top row must stay Weekly 4 / Pipeline 2 / Daily 4')
