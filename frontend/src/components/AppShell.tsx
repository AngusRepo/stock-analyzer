...
export default function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="sv-safe-shell min-h-screen overflow-x-hidden bg-[#090a0d] text-slate-100">
      <header className="sticky top-0 z-40 border-b border-white/[0.08] bg-[#111218]/95 shadow-[0_10px_32px_rgba(0,0,0,0.28)] backdrop-blur-xl">
      ...
      <main className="sv-stockintelli-page min-h-[calc(100dvh-56px)]">{children}</main>
    </div>
  )
}
