...
const schedule: ScheduleRow[] = [
  ...
  { task: 'active8-oof-daily', tw_time: 'Daily 01:55 (latest mature session)', owner: 'gcp_scheduler', parameter_mode: 'hard_boundary', layer: 'L4 allocation', description: 'Materializes the latest ready immutable purged-OOF cohort through L4/Fusion quality, parity, and automatic promotion gates.' },
