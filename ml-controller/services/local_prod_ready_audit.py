...
def _allocator_learning_candidate_checks(root: Path) -> list[dict[str, Any]]:
    return [
        ...
        _check_text_contains(
            root,
            "ml-controller/services/active8_ensemble_artifact.py",
            (
                "_fit_ridge",
            ...
            "roadmap:p5:active8_learned_artifact_builder",
            "Active-8 artifact parameters come from chronological OOF ridge/isotonic/conformal evidence with no top-k",
        ),
        _check_text_contains(
            root,
        ...
        _check_text_contains(
            root,
            "ml-service/app/active8_ensemble_runtime.py",
            (
            ...
            "roadmap:p5:active8_learned_conformal_runtime",
            "Formal L3 uses the immutable learned Active-8 conformal artifact with no top-k owner",
        ),
        _check_text_regex_absent(
            root,
            "ml-service/app/prediction_runtime.py",
            r"\b(load_ic_weights|rank_to_signal|score_to_signal)\b",
            "roadmap:p5:prediction_runtime_no_legacy_formula_owner",
            "Prediction runtime no longer imports IC/rank/score formula owners",
        ),
        _check_text_contains(
            root,
