...
assert(page.includes('xl:grid-cols-[minmax(0,1fr)_260px_300px]'), 'Desktop layout must place stage transition between the full workspace and lineage inspector')
