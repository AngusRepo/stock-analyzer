...

{
  ...
  assert(marketScreener.includes('market:tpex_attention_stocks'), 'screener restricted gate must reserve TPEX attention-list source')
  assert(marketScreener.includes('stock_trading_restrictions'), 'screener restricted gate must include D1 restriction governance')
  ...
  assert(marketScreener.includes('latestThemeUniverse'), 'RRG overlay must align stock_tags to the latest sector_flow theme universe')
  ...
  assert(pendingBuyOrchestrator.includes("WHERE tag_type = 'concept'"), 'pending-buy RRG gate must never mix industry/subindustry tags into theme RRG')
  ...
  assert(pendingBuyOrchestrator.includes('themeUniverse'), 'pending-buy RRG gate must align stock_tags to the latest sector_flow theme universe')
