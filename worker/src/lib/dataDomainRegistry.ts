...
const DOMAIN_TABLES: Record<DataDomain, ReadonlySet<string>> = {
  ...
  learning: new Set([
    ...
    'strategy_evidence_metric_snapshot_runs_v2', 'strategy_evidence_metric_snapshot_rows_v2',
...
const EXTENDED_PRODUCTION_TABLE_OWNERSHIP: readonly TableOwnershipMetadata[] = [
  ...
  { table: 'model_health_daily', domain: 'learning', disposition: 'full_scalar', route_ready: true, shadow_ready: true },
  { table: 'model_lifecycle_events', domain: 'learning', disposition: 'active_window', route_ready: true, shadow_ready: true },
  ...
  { table: 's12_calibration_work_v1', domain: 'learning', disposition: 'full_scalar', route_ready: true, shadow_ready: false },
  { table: 's12_calibration_work_current_v1', domain: 'learning', disposition: 'full_scalar', route_ready: true, shadow_ready: false },
  { table: 's12_calibration_work_rows_v1', domain: 'learning', disposition: 'active_window', route_ready: true, shadow_ready: false },
  { table: 's12_calibration_work_lifecycle_v1', domain: 'learning', disposition: 'active_window', route_ready: true, shadow_ready: false },
  { table: 's12_calibration_work_censor_v1', domain: 'learning', disposition: 'active_window', route_ready: true, shadow_ready: false },
  ...
  { table: 'paired_native_prestart_successions_v1', domain: 'learning', disposition: 'full_scalar', route_ready: true, shadow_ready: false },
  ...
  { table: 'finlab_source_sessions_v1', domain: 'market', disposition: 'full_scalar', route_ready: true, shadow_ready: false },
