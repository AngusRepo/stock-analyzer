...
export interface PaperExecutionEventInput {
  ...
  symbol?: string | null
  side?: 'buy' | 'sell' | null
  eventType: 'pending_buy' | 'paper_order' | 'paper_position_update' | 'debate' | 'snapshot_audit' | 'finlab_preview' | 'finlab_l5_market_data' | 'finlab_execution_preview' | 'paper_broker_reconciliation' | 'intraday_technical_decision' | 's12_intraday_structure'
  status: string
  reason?: string | null
