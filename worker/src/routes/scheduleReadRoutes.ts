...
scheduleReadRoutes.get('/api/cron/schedule', (c) => {
  const schedule = [
    ...
    { task: 'weekly-cleanup', tw_time: '週日 04:00', description: 'D1 / KV / runtime cleanup + lifecycle check; no retrain' },
    { task: 'weekly-backtest', tw_time: '週日 06:00', description: 'Lightweight validation: Backtest + Monte Carlo + PBO' },
