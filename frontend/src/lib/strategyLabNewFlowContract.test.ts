...
assert(page.includes('<StrategyStageTransitionCard') && page.includes('aria-label="Atomic V7 相對替換指標"') && page.includes('查看原始 NAV') && page.includes('if (selectedRow) setAtomicV7StrategyKey'), 'The lower indicator opens candidate or incumbent original evidence')
