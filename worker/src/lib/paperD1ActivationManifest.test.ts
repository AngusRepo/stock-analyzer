...
assert(wrangler.includes('MULTI_D1_ACTIVE_DOMAINS = "learning,execution,paper,research"'))
assert(deploy.includes('MULTI_D1_ACTIVE_DOMAINS="${MULTI_D1_ACTIVE_DOMAINS:-learning,execution,paper,research}"'))
