...
const JOB_DEFS: JobDef[] = [
  ...
  { id: 'allocator-ev-readiness', name: 'Allocator EV Readiness', schedule: 'Before pipeline recommendation', cron: '', group: 'pipeline_chain', chainIndex: 8 },
  { id: 'pipeline', name: 'Pipeline', schedule: 'After screener + regime + allocator EV readiness', cron: '', group: 'pipeline_chain', chainIndex: 9 },
  ...
  { id: 'paper-active-postmarket', name: 'Paper Active Postmarket', schedule: 'After daily report', cron: '', group: 'pipeline_chain', chainIndex: 20 },
  { id: 'obsidian-sync', name: 'Obsidian Sync', schedule: 'After paper-active postmarket', cron: '', group: 'pipeline_chain', chainIndex: 21 },
  { id: 'meta-learning-shadow', name: 'Meta Learning Shadow', schedule: 'After obsidian sync', cron: '', group: 'pipeline_chain', chainIndex: 22 },
  { id: 'strategy-learning', name: 'Strategy Learning', schedule: 'After meta shadow / historical reruns', cron: '', group: 'pipeline_chain', chainIndex: 23 },
  ...
  { id: 'legacy-strategy-evidence-migration', name: 'Legacy Strategy Evidence Migration', schedule: 'Daily 01:50–05:50 hourly', cron: '50 17-21 * * *', group: 'daily' },
  { id: 'legacy-hot-data-retirement', name: 'Legacy Hot Data Retirement', schedule: 'Daily 01:10–05:10 hourly', cron: '10 17-21 * * *', group: 'daily' },
  ...
  { id: 'opb-arm-prior-refresh', name: 'OPB Arm Prior Refresh', schedule: 'Sunday 07:15', cron: '15 23 * * 6', group: 'weekly' },
  ...
  { id: 'monthly-opb-arm-prior-refresh', name: 'Monthly OPB Arm Prior Refresh', schedule: 'First Sunday 01:50', cron: 'first sunday of month 01:50 taipei', group: 'monthly' },
