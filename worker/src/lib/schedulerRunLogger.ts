...
const TASK_NAMES: Record<string, string> = {
  ...
  'post-verify-learning-dispatch': 'Post Verify Learning Dispatch',
  'post-verify-learning-step': 'Post Verify Learning Step',
  'post-verify-learning-closure': 'Post Verify Learning Closure',
