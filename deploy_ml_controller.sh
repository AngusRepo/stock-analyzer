...
MULTI_D1_ACTIVE_DOMAINS="${MULTI_D1_ACTIVE_DOMAINS:-learning,execution,paper}"
...
MULTI_D1_PAPER_CUTOVER_RECEIPT_ID="${MULTI_D1_PAPER_CUTOVER_RECEIPT_ID:-data-domain-cutover-probe:paper:2aa72eee-6276-4098-b837-bd91b0b423d7}"
MULTI_D1_PAPER_WRITER_EPOCH="${MULTI_D1_PAPER_WRITER_EPOCH:-5}"
