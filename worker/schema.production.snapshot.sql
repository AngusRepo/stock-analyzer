-- Canonical D1 schema snapshot generated from production sqlite_master.
-- Generated: 2026-07-14 (read-only export; excludes data and Cloudflare internal tables).
-- Object inventory: 157 tables, 223 indexes, 1 view.
-- Future schema changes must land as ordered migrations and refresh this snapshot.
...
CREATE TABLE "model_artifact_registry" (
  ...
  model_name                  TEXT NOT NULL,
  version                     TEXT NOT NULL,
  candidate_type              TEXT NOT NULL CHECK(candidate_type IN ('monthly_release','weekly_drift','manual_hotfix','model_family_shadow','research_benchmark','timesfm_l175_l2_feature_release','l4_alpha_ev_refresh','allocator_ev_fusion_refresh','unknown')),
...
CREATE TABLE "sector_flow" (
  ...
  rs_momentum     REAL,
  quadrant        TEXT,
  created_at      TEXT NOT NULL DEFAULT (datetime('now')), turnover_value REAL, turnover_share REAL, turnover_share_delta REAL, rotation_velocity REAL, rotation_acceleration REAL, quadrant_age INTEGER, transition_path TEXT, rotation_score REAL, rotation_regime TEXT, rotation_hysteresis TEXT, rotation_window INTEGER, rrg_tail_json TEXT,
...
CREATE TABLE strategy_decision_log (
  ...
  created_at               TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, context_id TEXT, evidence_artifact_id TEXT,
