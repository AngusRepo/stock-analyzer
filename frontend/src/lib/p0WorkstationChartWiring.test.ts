...
assert(
  modelChart.includes('!model.serving_block_reason') && modelChart.includes('model.serving_owner || model.serving_artifact_id'),
  'ModelPoolHealthChart must require authoritative serving ownership and no blocker',
)
