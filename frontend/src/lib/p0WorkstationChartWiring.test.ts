...
assert(modelPoolPage.includes('UpgradeTrackPanelV2'), 'ModelPool page should render near-production L3 model tracks')
...
assert(modelPoolPage.includes('L2 coarse、L3 family ML、近 production 候選'), 'ModelPool KPI copy should describe the new screener model flow')
