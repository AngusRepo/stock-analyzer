...
export type Bindings = {
  ...
  // Execution candidate watch pool controls.
  EXECUTION_WATCH_POOL_SIZE?: string
  EXECUTION_WATCH_MIN_ML_EDGE?: string
  EXECUTION_WATCH_MIN_FINAL_SCORE?: string
  EXECUTION_WATCH_RISK_MULTIPLIER?: string
  EXECUTION_CLOSE_WINDOW_MIN_VOLUME_RATIO?: string
  // FinLab L5 / intraday technical execution guards.
  FINLAB_L5_MARKET_DATA_ENABLED?: string
  FINLAB_L5_MARKET_DATA_ALLOW_BROKER_LOGIN?: string
  FINLAB_L5_MAX_QUOTE_AGE_MS?: string
  FINLAB_L5_MAX_SPREAD_PCT?: string
  FINLAB_L5_MIN_DEPTH_LEVELS?: string
  FINLAB_L5_MIN_TOP_ASK_VOLUME?: string
  FINLAB_L5_MIN_ORDER_BOOK_IMBALANCE?: string
  FINLAB_L5_ENVELOPE_GUARD_ENABLED?: string
  INTRADAY_DYNAMIC_TECHNICAL_GUARD_ENABLED?: string
  INTRADAY_TECHNICAL_DISTRIBUTION_SKIP_MIN_BARS?: string
  ENTRY_MODEL_V2_OPENING_FAST_PATH_ENABLED?: string
  ENTRY_MODEL_V2_OPENING_FAST_PATH_MAX_MINUTES?: string
  ENTRY_MODEL_V2_OPENING_FAST_PATH_ALLOW_TREND_UNAVAILABLE?: string
  ENTRY_MODEL_V2_OPENING_FAST_PATH_MAX_PREMIUM_PCT?: string
...
export interface UpdateQueueMsg {
  type: 'update_batch' | 'finalize_update' | 'post_indicator_screener' | 'post_screener_pipeline' | 'post_verify_learning_closure' | 'news_batch' | 'source_readiness_retry'
  newsStocks?: Array<{
    id: number
    symbol: string
    market?: string | null
