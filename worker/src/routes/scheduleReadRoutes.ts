...
const schedule: ScheduleRow[] = [
  ...
  { task: 'active8-oof-daily', tw_time: 'Tue-Sat 01:55 (prior trading session)', owner: 'gcp_scheduler', parameter_mode: 'hard_boundary', layer: 'L4 allocation', description: 'Materializes the latest ready immutable purged-OOF cohort through L4/Fusion quality, parity, and automatic promotion gates.' },
  { task: 'active8-oof-daily-watchdog', tw_time: '02:25-04:55 / 30m', owner: 'gcp_scheduler', parameter_mode: 'hard_boundary', layer: 'L4 allocation', description: 'Retries immutable prep dependencies and resumes the same idempotent OOF lifecycle.' },
