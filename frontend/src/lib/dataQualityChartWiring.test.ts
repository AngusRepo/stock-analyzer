...
assert(page.includes('MarketMaterializationPanel'), 'DataQualityPage should render homepage market materialization audit')
assert(page.includes('market_dashboard_materialization'), 'DataQualityPage should surface market dashboard materialization checks')
