...
assert(workbench.includes('Promotion readiness'), 'Model Pool cockpit must keep selected-model readiness as one focused drilldown panel')
...
assert(workbench.includes('Promotion readiness funnel'), 'Selected-model drilldown must show the release readiness funnel')
assert(workbench.includes('L2 coarse -> L3 family'), 'Model Pool cockpit must show the L2/L3 ownership split')
assert(workbench.includes('dataset, pointer, promotion pressure, PBO/CPCV, and missing evidence'), 'Model Pool cockpit must show dataset, pointer, promotion pressure, PBO/CPCV, and missing evidence in the evidence table')
