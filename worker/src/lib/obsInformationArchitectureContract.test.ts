...
assert(standaloneJobsCss.includes('.obs-standalone__group') && standaloneJobsCss.includes('.obs-standalone__rows') && !standaloneJobsCss.includes('.obs-standalone__group-card'), 'standalone registry must preserve the restored grouped-row presentation')
...
assert(obs.includes('2xl:grid-cols-[minmax(0,1fr)_minmax(540px,0.78fr)]') && obs.includes('md:grid-cols-3'), 'Source Gates must remain a full right-side block beside three readiness cards')
