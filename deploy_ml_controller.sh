...
MULTI_D1_ACTIVE_DOMAINS="${MULTI_D1_ACTIVE_DOMAINS:-learning,ops,core,market,execution,paper,research}"
...
MULTI_D1_OPS_ROUTING_CONTRACT="${MULTI_D1_OPS_ROUTING_CONTRACT:-ops-single-writer-epoch-v1}"
MULTI_D1_OPS_CUTOVER_RECEIPT_ID="${MULTI_D1_OPS_CUTOVER_RECEIPT_ID:-data-domain-cutover-probe:ops:c23aeba4-1788-4a19-9f98-b18fe2ff3890}"
MULTI_D1_OPS_WRITER_EPOCH="${MULTI_D1_OPS_WRITER_EPOCH:-227728}"
...
MULTI_D1_CORE_ROUTING_CONTRACT="${MULTI_D1_CORE_ROUTING_CONTRACT:-core-single-writer-epoch-v1}"
MULTI_D1_CORE_CUTOVER_RECEIPT_ID="${MULTI_D1_CORE_CUTOVER_RECEIPT_ID:-data-domain-cutover-probe:core:df3c14b3-e1d4-46cf-bd8f-d9d5dbf8f594}"
MULTI_D1_CORE_WRITER_EPOCH="${MULTI_D1_CORE_WRITER_EPOCH:-1}"
MULTI_D1_MARKET_ROUTING_CONTRACT="${MULTI_D1_MARKET_ROUTING_CONTRACT:-market-single-writer-epoch-v1}"
MULTI_D1_MARKET_CUTOVER_RECEIPT_ID="${MULTI_D1_MARKET_CUTOVER_RECEIPT_ID:-data-domain-cutover-probe:market:9b026110-adf6-492b-ac15-e65a4843ef69}"
MULTI_D1_MARKET_WRITER_EPOCH="${MULTI_D1_MARKET_WRITER_EPOCH:-1}"
...
CF_WORKERS_AI_API_TOKEN_SECRET="${CF_WORKERS_AI_API_TOKEN_SECRET:-stockvision-workers-ai-token:latest}"
...
# Persist the dedicated inference/analytics binding on every release.
BASE_SECRET_BINDINGS="${BASE_SECRET_BINDINGS},CF_WORKERS_AI_API_TOKEN=${CF_WORKERS_AI_API_TOKEN_SECRET}"
...
RUNTIME_ENV_VARS="${RUNTIME_ENV_VARS},MULTI_D1_OPS_ROUTING_CONTRACT=${MULTI_D1_OPS_ROUTING_CONTRACT}"
RUNTIME_ENV_VARS="${RUNTIME_ENV_VARS},MULTI_D1_OPS_CUTOVER_RECEIPT_ID=${MULTI_D1_OPS_CUTOVER_RECEIPT_ID}"
RUNTIME_ENV_VARS="${RUNTIME_ENV_VARS},MULTI_D1_OPS_WRITER_EPOCH=${MULTI_D1_OPS_WRITER_EPOCH}"
...
RUNTIME_ENV_VARS="${RUNTIME_ENV_VARS},MULTI_D1_CORE_ROUTING_CONTRACT=${MULTI_D1_CORE_ROUTING_CONTRACT}"
RUNTIME_ENV_VARS="${RUNTIME_ENV_VARS},MULTI_D1_CORE_CUTOVER_RECEIPT_ID=${MULTI_D1_CORE_CUTOVER_RECEIPT_ID}"
RUNTIME_ENV_VARS="${RUNTIME_ENV_VARS},MULTI_D1_CORE_WRITER_EPOCH=${MULTI_D1_CORE_WRITER_EPOCH}"
RUNTIME_ENV_VARS="${RUNTIME_ENV_VARS},MULTI_D1_MARKET_ROUTING_CONTRACT=${MULTI_D1_MARKET_ROUTING_CONTRACT}"
RUNTIME_ENV_VARS="${RUNTIME_ENV_VARS},MULTI_D1_MARKET_CUTOVER_RECEIPT_ID=${MULTI_D1_MARKET_CUTOVER_RECEIPT_ID}"
RUNTIME_ENV_VARS="${RUNTIME_ENV_VARS},MULTI_D1_MARKET_WRITER_EPOCH=${MULTI_D1_MARKET_WRITER_EPOCH}"
...
REQUIRED_ENV_VARS=(
  ...
  MULTI_D1_OPS_ROUTING_CONTRACT
  MULTI_D1_OPS_CUTOVER_RECEIPT_ID
  MULTI_D1_OPS_WRITER_EPOCH
  ...
  MULTI_D1_CORE_ROUTING_CONTRACT
  MULTI_D1_CORE_CUTOVER_RECEIPT_ID
  MULTI_D1_CORE_WRITER_EPOCH
  MULTI_D1_MARKET_ROUTING_CONTRACT
  MULTI_D1_MARKET_CUTOVER_RECEIPT_ID
  MULTI_D1_MARKET_WRITER_EPOCH
  CF_D1_CORE_DB_ID
  CF_D1_MARKET_DB_ID
  CF_KV_NAMESPACE_ID
)
...
sync_dataset_snapshot_job() {
  ...
  echo "Dataset snapshot job sync + pipeline IAM succeeded"
  echo ""
}
run_preflight() {
  ...
  print_preflight_value "CF_WORKERS_AI_API_TOKEN_SECRET"
...
GCLOUD_UPLOAD_CONTEXT="$(cd "$SCRIPT_DIR" && gcloud meta list-files-for-upload 2>/dev/null | sed 's#\\#/#g')"
if ! grep -Fx 'infra/gcp-scheduler-jobs.json' <<<"$GCLOUD_UPLOAD_CONTEXT" >/dev/null; then
